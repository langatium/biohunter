 ...
 * https://help.hana.ondemand.
 * com/help/frameset.htm?e62cd24abb571014b73792d85402f104.html
 */
public class DocumentStore extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			String uniqueName = "com.sap.innojam.biohunter";
			...
			response.getWriter().println(
					"The root folder of the repository with id " + root.getId()
							+ " contains the following objects:<ul>");
			for (CmisObject o : children) {
				response.getWriter().print("<li>" + o.getName());
				if (o instanceof Folder) {
					response.getWriter().println(
							" createdBy: " + o.getCreatedBy() + "</li>");
				} else {
					Document doc = (Document) o;
					response.getWriter().println(
							" createdBy: " + o.getCreatedBy() + " filesize: "
