	    	...
	    	if ( oDoc.metatype === ".control" ) {
			    ...
			    if ( n.length > 0 ) {
				    ...
				    for(var i=0; i<n.length; i++) {
				    	...
				    	rm.write("<tr", alternate(i), "><td class='sapDkCueCdName", deprClass(oProp), "'>", n[i], "</td>", "<td class='sapDkCueCdType'>", crossref(oProp, oProp.type, oProp.cardinality), "</td>", "<td class='sapDkCueCdDoc'>", oProp.doc, deprDoc(oProp), "</td></tr>");
				    } 
			    }
