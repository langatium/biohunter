...
/**
 * Initialization Code and shared classes of library sap.ui.demokit (1.16.7)
 */
...
sap.ui.lazyRequire("sap.ui.demokit.DemokitApp");
		...
		jQuery("[cue-card]").each(function() {
			...
			new sap.ui.demokit.UI5EntityCueCard({ 
				...
				navigate: function(oEvent) {
					top.navigateToType(oEvent.getParameter("entityName"));
