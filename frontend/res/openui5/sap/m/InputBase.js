...
sap.m.InputBase.prototype.onAfterRendering=function(){this._$input=jQuery.sap.byId(this.getId()+"-inner");this._$input.bind("change",this._changeProxy);if(this._showLabelAsPlaceholder){this._$label=this.$().find('label');this._setLabelVisibility();if(sap.ui.Device.os.ios&&sap.ui.Device.os.version<=5){this._$label.bind("click",function(){})}}};
